---
description: Demo for making an immediate swap
---
...
{% hint style="info" %}
To support small quantity trading, we introduce an additional concept <mark style="color:orange;">`tradeCost`</mark>, which is the minimum gas fee when a trade transaction is uplink to Ethereum.
{% endhint %}
...
<summary>Calculate swap function</summary>
...
<summary>Mock Swap Data</summary>
